...
class Ui_SignUp(object):
    ...
    def setupUi(self, SignUp):
        ...
        self.signupf.setStyleSheet("border: 1px solid black;")
    ...
    def retranslateUi(self, SignUp):
        ...
        self.label_4.setText(_translate("SignUp", "Password must contain atleast one digit."))
